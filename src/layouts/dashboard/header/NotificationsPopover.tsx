/*
 * @FilePath: /mog-admin/src/layouts/dashboard/header/NotificationsPopover.tsx
 * @author: Wibus
 * @Date: 2022-10-07 08:32:51
 * @LastEditors: Wibus
 * @LastEditTime: 2022-10-07 08:41:08
 * Coding With IU
 */
...
const _notifications = [...Array(5)].map((_, index) => {
  ...
  avatar: [null, `https://minimal-assets-api.vercel.app/assets/images/avatars/avatar_${index + 1}.jpg`, null, null, null][index],
