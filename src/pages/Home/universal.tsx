...
export const Widget = ({
  ...
  return <div className={clsx(styles.widget, className)}>{children}</div>;
};
...
export const TableContainer = ({
  ...
  return (
    <div className={clsx(styles.tableContainer, className)} style={style}>
      <div
...
export const TableItemValue = ({
  ...
  return (
    <span className={clsx(styles.tableItemTitle, className)}>{children}</span>
  );
};
