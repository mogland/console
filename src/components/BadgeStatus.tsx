/*
 * @FilePath: /mog-admin/src/components/BadgeStatus.tsx
 * @author: Wibus
 * @Date: 2022-10-06 17:46:17
 * @LastEditors: Wibus
 * @LastEditTime: 2022-10-06 17:53:02
 * Coding With IU
 */
...
const RootStyle = styled('span')((data) => {
  const { theme, ownerState } = data as any;
