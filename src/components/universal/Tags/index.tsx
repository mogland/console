...
export const Tags: React.FC<TagsProp> = (props) => {
  ...
  const handleConfirmWithAutoComplete = (value?: string) => {
    if (inputValue && tags.indexOf(inputValue) === -1 || value && tags.indexOf(value) === -1) {
...
export const Input = forwardRef<HTMLInputElement, PropsWithRef<PropsWithChildren & React.HTMLAttributes<HTMLInputElement>> & { onPressEnter?: () => void, onAutoComplete?: (value?: string) => void }>((props, ref) => {
