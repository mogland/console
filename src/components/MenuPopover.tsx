/*
 * @FilePath: /mog-admin/src/components/MenuPopover.tsx
 * @author: Wibus
 * @Date: 2022-10-06 17:46:10
 * @LastEditors: Wibus
 * @LastEditTime: 2022-10-06 17:54:31
 * Coding With IU
 */
...
const ArrowStyle = styled('span')((data) => {
  const { arrow, theme } = data as any;
  const SIZE = 12;
...
}) as React.FC<{ arrow: string, theme?: any }>;
