...
Dashboards.Area = (props: { children: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined, border?: boolean, className?: string, style?: any },) => {
  return (
    <section className={useClasses(styles.dashboardArea, styles.mixed)}>
      <div className={useClasses(styles.dashboardContainer)}>
        <div className={useClasses(styles.dashboardBox, styles.blogPost, props.border ? "" : "border-none", props.className)} style={props.style}>
          {props.children}
        </div>
      </div>
    </section>
