/*
 * @FilePath: /nx-admin/src/components/widgets/Editor/exports/html-to-draft/index.ts
 * @author: Wibus
 * @Date: 2022-07-23 19:46:14
 * @LastEditors: Wibus
 * @LastEditTime: 2022-07-23 19:50:30
 * Coding With IU
 */
...
import getSafeBodyFromHTML from './parse';
import rangeSort from './range-sort';
  ...
  return chunk.text.split('\r').map((textBlock, blockIndex) => {
    ...
    const characterList = List(
      inlines.map((style, entityIndex) => {
        const data = { style, entity: undefined };
